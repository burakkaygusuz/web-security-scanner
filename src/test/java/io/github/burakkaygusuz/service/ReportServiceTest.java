...
class ReportServiceTest {
    ...
    void setUp() {
        ...
        sqlVulnerability = new Vulnerability(
            "SQL Injection",
        ...
        xssVulnerability = new Vulnerability(
        ...
        sensitiveInfoVulnerability = new Vulnerability(
    ...
    void testReportVulnerability() {
        ...
        assertThat(reportService)
            .extracting(ReportService::getVulnerabilityCount)
            .isEqualTo(1);
        
        assertThat(reportService.getVulnerabilities())
            .hasSize(1)
            .containsExactly(sqlVulnerability);
    }
    ...
    void testGetFirstAndLastVulnerability() {
        ...
        SoftAssertions.assertSoftly(softly -> {
            ...
            softly.assertThat(reportService.getLastVulnerability()).isEqualTo(sensitiveInfoVulnerability);
        });
    }
    ...
    void testSeveritySortingWithSameSeverityDifferentTypes() {
        Vulnerability customVulnerability = new Vulnerability(
            "Unknown Type",
