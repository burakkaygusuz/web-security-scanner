...
class UrlUtilsTest {
  ...
  void testParseParametersWithEmptyParameter() {
    ...
    assertThat(params).hasSize(2).containsEntry("id", "123").containsEntry("name", "john");
  }
  ...
  void testParseParametersWithEmptyKey() {
    ...
    assertThat(params).hasSize(1).containsEntry("id", "123");
  }
  ...
  void testBuildTestUrlWithNewParameter() {
    ...
    assertThat(testUrl).contains("id=123").contains("newParam=newValue");
  }
  ...
  void testIsValidUrlWithValidUrls() {
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(UrlUtils.isValidUrl("https://example.com:8080/path?param=value"))
              .isTrue();
  ...
  void testBuildTestUrlPreservesFragment() {
    ...
    assertThat(testUrl).contains("id=999").contains("#section1");
  }
  ...
  void testBuildTestUrlWithMultipleEqualSigns() {
    ...
    assertThat(testUrl).contains("id=999").contains("data=key=value");
  }
